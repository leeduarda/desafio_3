  ...
  return (
    <section className="relative">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col justify-center items-center text-customBlack1 gap-y-0 md:gap-y-3">
        <h2 className="font-poppins font-medium text-2xl md:text-5xl text-center">Shop</h2>
        <ul className="flex flex-row items-center gap-3">
          <Link className="font-poppins font-medium text-sm md:text-base" to="/">
            Home
          </Link>
          <img className="mr-1" src={imageVector} alt="" />
          <li className="font-poppins font-light text-sm md:text-base">
            Shop
          </li>
        </ul>
      </div>
...
export default ShopBannerCarrinho;
